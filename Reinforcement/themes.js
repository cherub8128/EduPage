const themes = [
    { emoji: "🍾", title: "병 세우기 챌린지", description: "로봇팔이 물병을 던져 똑바로 세우는 '병 세우기' 챌린지를 성공시키도록 학습합니다.", rl_concept: "병 세우기 챌린지: 로봇팔의 각도와 힘을 조절하여, 테이블 위의 물병을 던졌을 때 바닥에 똑바로 서도록 만드는 게임" },
